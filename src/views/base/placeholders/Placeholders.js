  ...
  <CRow>
    ...
    <CCol xs={12}>
            ...
            <div className="d-flex justify-content-around p-3">
              ...
              <CCard style={{ width: '18rem' }}>
                ...
                <CCardBody>
                  ...
                  <CPlaceholder component={CButton} disabled href="#" tabIndex={-1} xs={6} />
                </CCardBody>
              </CCard>
            </div>
          </DocsExample>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            column propx (e.g., <code>xs={6}</code>) to set the <code>width</code>. They can replace
            the text inside an element or be added as a modifier class to an existing component.
          </p>
          <DocsExample href="components/placeholder">
            <p aria-hidden="true">
              <CPlaceholder xs={6} />
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            The size of <code>&lt;CPlaceholder&gt;</code>s are based on the typographic style of the
            parent element. Customize them with <code>size</code> prop: <code>lg</code>,{' '}
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            <code>animation=&#34;wave&#34;</code> to better convey the perception of something being{' '}
