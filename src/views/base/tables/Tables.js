  ...
  <CRow>
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            Add <code>small</code> property to make any <code>&lt;CTable&gt;</code> more compact by
            cutting all cell <code>padding</code> in half.
          </p>
              ...
              <CTableBody>
                <CTableRow>
                  ...
                  <CTableDataCell>
                    ...
                    space, to demonsCTableRowate how the vertical alignment works in the preceding
                    cells.
                  </CTableDataCell>
                </CTableRow>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            users with screen readers to find a table and understand what it&#39;s about and decide
