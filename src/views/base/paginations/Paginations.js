  ...
  <CRow>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            provide proper screen reader support with <code>aria</code> attributes.
          </p>
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            Pagination links are customizable for different circumstances. Use <code>disabled</code>{' '}
          ...
          <p className="text-medium-emphasis small">
            ...
            such, we always add <code>tabindex=&#34;-1&#34;</code> on disabled links and use custom
