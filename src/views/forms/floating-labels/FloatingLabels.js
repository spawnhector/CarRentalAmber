      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            pseudo-element. Also note that the <code>&lt;CFormInput&gt;</code> must come first so we
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <DocsExample href="forms/floating-labels#textareas">
            <CFormFloating>
              <CFormTextarea id="floatingTextarea" placeholder="Leave a comment here" />
          ...
          <p className="text-medium-emphasis small">
            ...
            <code>rows</code> attribute. Instead, set an explicit <code>height</code> (either inline
            or via custom CSS).
          </p>
          <DocsExample href="forms/floating-labels#textareas">
            <CFormFloating>
