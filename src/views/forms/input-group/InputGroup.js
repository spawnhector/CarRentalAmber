  ...
  <CRow>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            sides of an input. Remember to place <code>&lt;CFormLabel&gt;</code>s outside the input
            group.
          </p>
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            Add the relative form sizing classes to the <code>&lt;CInputGroup&gt;</code> itself and
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            styles are only available for input groups with a single <code>&lt;CFormInput&gt;</code>
            .
          </p>
