  ...
  <CRow>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            CoreUI includes a bunch of predefined buttons components, each serving its own semantic
            purpose. Buttons show what action will happen when the user clicks or touches it. CoreUI
            buttons are used to initialize operations, both in the background or foreground of an
            experience.
          </p>
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            The <code>&lt;CButton&gt;</code> component are designed for <code>&lt;button&gt;</code>{' '}
            , <code>&lt;a&gt;</code> or <code>&lt;input&gt;</code> elements (though some browsers
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            If you need a ghost variant of button, set <code>variant=&#34;ghost&#34;</code> prop to
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            Add the <code>disabled</code> boolean prop to any <code>&lt;CButton&gt;</code> component
            to make buttons look inactive. Disabled button has <code>pointer-events: none</code>{' '}
          ...
          <p className="text-medium-emphasis small">
            <code>&lt;a&gt;</code>s don&#39;tsupport the <code>disabled</code> attribute, so CoreUI
